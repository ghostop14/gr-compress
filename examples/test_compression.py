...
# Generated: Thu Jun 20 16:28:42 2019
##################################################
...
class test_compression(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Test Compression")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Test Compression")
        ...
        self.settings = Qt.QSettings("GNU Radio", "test_compression")
        ...
        self.compress_decompress_0 = compress.decompress(gr.sizeof_gr_complex,False,False)
        self.compress_compress_0 = compress.compress(gr.sizeof_gr_complex,64000,4,False,True)
        ...
        self.connect((self.compress_decompress_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.compress_decompress_0, 0), (self.rational_resampler_xxx_1, 0))
...
def main(top_block_cls=test_compression, options=None):
