...
# Title: Test Compression3
# Generated: Thu Jun 20 16:34:13 2019
##################################################
...
class test_compression3(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Test Compression3")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Test Compression3")
        ...
        self.settings = Qt.QSettings("GNU Radio", "test_compression3")
        ...
        self.grnet_Int16BytesToComplex_0 = grnet.Int16BytesToComplex()
        self.filerepeater_file_repeater_ex_0 = filerepeater.file_repeater_ex(gr.sizeof_char*1, '/media/mpiscopo/18d6f16c-02e7-4056-9f85-042e4c546179/Recordings/Voyager/voyager-58620.311555.16ic', 0, 0.0,True,0,0,False)
        ...
        self.connect((self.compress_decompress_0, 0), (self.grnet_Int16BytesToComplex_0, 0))
        self.connect((self.filerepeater_file_repeater_ex_0, 0), (self.blocks_throttle_0, 0))
        self.connect((self.grnet_Int16BytesToComplex_0, 0), (self.qtgui_freq_sink_x_0, 0))
...
def main(top_block_cls=test_compression3, options=None):
